...
- [01 - Individual Problem Scan](#01---individual-problem-scan)
- [02 - Group Problem Statement](#02---group-problem-statement)
- [03 - Individual Reflection](#03---individual-reflection)
...
Vì vậy, nhóm không chọn một bài quá hẹp như "hỏi giá bao nhiêu" hay "gom đơn cuối ngày", mà chọn candidate rộng vừa đủ:
...
```text
Không làm "AI chatbot tự bán hàng toàn bộ".
Không làm "Agent tự chốt đơn, tự đổi trả, tự hoàn tiền".
Không làm hệ thống tích hợp live đầy đủ 4 nền tảng trong lab.
...
| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------ | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| Meta Business Suite Inbox                   | https://www.facebook.com/business/help/294426838452244                                                          | Quản lý tin nhắn trong hệ Meta như Messenger, Instagram, WhatsApp       | Tốt nếu shop bán chủ yếu trên Facebook/Instagram       | Không gom được Zalo, Shopee, TikTok Shop                                         | Inbox chung là hướng đúng, nhưng cần nhìn đa nền tảng                            |
| Zalo OA Webhook / OpenAPI                   | https://developers.zalo.me/docs/official-account/webhook/tong-quan                                              | Cho phép hệ thống nhận sự kiện/tương tác từ Zalo OA qua webhook         | Có thể tích hợp Zalo vào workflow riêng                | Cần OA, app, quyền API và kỹ thuật tích hợp                                      | Zalo có thể là một nguồn dữ liệu trong workflow, nhưng không nên pilot live ngay |
| Shopee Auto-Reply                           | https://seller.shopee.sg/edu/article/20316/auto-reply                                                           | Tự động gửi tin nhắn trả lời khi người mua nhắn tin mới                 | Hữu ích cho câu chào, FAQ đơn giản, ngoài giờ làm việc | Chỉ nằm trong Shopee, không hiểu sâu ngữ cảnh, khó tư vấn size/chốt đơn phức tạp | Rule/auto-reply đủ cho một phần FAQ, chưa đủ cho toàn bộ workflow                |
| TikTok Shop Customer Service Chat Assistant | https://seller-vn.tiktok.com/university/course?content_id=1531423807063809&lang=en&learning_id=7986455721625360 | Auto-reply, recommended answers, chatbot functions cho CSKH TikTok Shop | Pattern tốt: gợi ý câu trả lời, tăng hiệu suất CSKH    | Nằm trong TikTok Shop, không giải quyết đa kênh ngoài nền tảng                   | Nên thiết kế AI như assistant gợi ý, không phải agent tự quyết                   |
| TikTok Shop Customer Service API            | https://partner.tiktokshop.com/docv2/page/customer-service-api-overview                                         | Có thể forwarding tin nhắn buyer sang hệ thống CSKH bên thứ ba          | Hữu ích nếu sau này muốn tích hợp thật                 | Cần quyền API, setup kỹ thuật, không phù hợp pilot 4 tiếng                       | Pilot nên mô phỏng bằng Google Sheet trước khi tích hợp API thật                 |
| POS / inbox tool đa kênh                    | Cần verify theo tool cụ thể như Pancake, Abit, Harasocial hoặc tool tương tự                                    | Gom hội thoại, đơn hàng, khách hàng về một nơi                          | Có thể giải quyết một phần vận hành đa kênh            | Có chi phí, phụ thuộc nền tảng, không phải lúc nào cũng có AI hiểu ngữ cảnh      | Non-AI/tool có thể giải một phần, nên AI chỉ cần hỗ trợ bước hiểu/gợi ý          |
...
-> [3 Phân loại intent: hỏi giá / tồn kho / ship / size / đơn hàng / khiếu nại: 15']  <-- bottleneck
...
-> [3 AI tra bảng sản phẩm, bảng giá, tồn kho, size chart, chính sách ship và gợi ý câu trả lời: 10']  -- Workflow/AI
...
Bottleneck mới:
Chủ shop/CSKH review và chỉnh sửa. Đây là bottleneck chấp nhận được vì đó là điểm kiểm soát chất lượng trước khi phản hồi khách.
```
...
Problem Statement v0 đã rõ actor và workflow, nhưng còn hơi rộng vì bao gồm cả FAQ, tư vấn size, chốt đơn, trạng thái đơn và khiếu nại. Sau khi thảo luận, nhóm thu hẹp AI intervention vào phần:

```text
Phân loại intent + gợi ý câu trả lời cho các câu hỏi phổ biến.
```
